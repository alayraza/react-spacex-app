...
`}
                    ...
                    <div className="flex justify-end items-end pb-2 px-2">
                      <a
                        ...
                        rel="noopener noreferrer"
                      >
                        <span className="rounded-full w-12 h-12 primarybutton flex justify-center items-center cursor-pointer transform scale-100 hover:scale-110 bounce transition duration-300 ease-in-out">
                          <svg
                            id="Capa_1"
                            x="0px"
                            y="0px"
